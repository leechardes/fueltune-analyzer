...
from src.integration.ftmanager_bridge import (
    FTManagerIntegrationBridge, 
    IntegrationResult
)
from src.integration.format_detector import (
    FTManagerFormatDetector, 
    DetectionResult, 
    FormatCandidate
)
from src.integration.clipboard_manager import (
    ClipboardManager, 
    ClipboardResult
)
from src.integration.validators import (
    FTManagerValidator, 
    ValidationResult, 
    ValidationIssue
)
...
0.830\t0.840\t0.850\t0.860"""
    ...
    def test_detect_tabulated_format(self, format_detector: FTManagerFormatDetector, sample_tabulated_data: str):
    ...
    def test_detect_csv_format(self, format_detector: FTManagerFormatDetector, sample_csv_data: str):
    ...
    def test_detect_headers(self, format_detector: FTManagerFormatDetector, sample_with_headers: str):
    ...
    def test_confidence_threshold(self, format_detector: FTManagerFormatDetector, sample_tabulated_data: str):
    ...
    def test_performance_requirement(self, format_detector: FTManagerFormatDetector, sample_tabulated_data: str):
    ...
    def test_content_structure_analysis(self, format_detector: FTManagerFormatDetector, sample_tabulated_data: str):
...
0.820\t0.830\t0.840\t0.850"""
    ...
    def test_validate_valid_clipboard_data(self, validator: FTManagerValidator, valid_clipboard_content: str):
    ...
    def test_validate_valid_map_data(self, validator: FTManagerValidator, valid_map_data: pd.DataFrame):
    ...
    def test_validate_expected_dimensions(self, validator: FTManagerValidator, valid_clipboard_content: str):
        """Test validation against expected dimensions."""
        
        # Content has 4x4 dimensions
        result = validator.validate_clipboard_data(
            valid_clipboard_content, 
    ...
    def test_performance_requirement(self, validator: FTManagerValidator, valid_clipboard_content: str):
...
class TestFTManagerIntegrationBridge:
    ...
    def test_create_streamlit_ui(self, mock_st: Mock, integration_bridge: FTManagerIntegrationBridge):
    ...
    def test_operation_tracking(self, mock_track: Mock, integration_bridge: FTManagerIntegrationBridge):
...
0.750\t0.760\t0.770\t0.780\t0.790\t0.800\t0.810\t0.820"""
    ...
    def test_complete_import_export_cycle(self, sample_ftmanager_data: str):
        ...
        with patch.object(bridge.clipboard_manager, 'get_content') as mock_get:
            mock_get.return_value = ClipboardResult(
                success=True, 
                content=sample_ftmanager_data
            )
