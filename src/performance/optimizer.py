...
class IntelligentCache:
    ...
    def get_metrics(self) -> CacheMetrics:
        ...
        with self._lock:
            ...
            cache_size_bytes = 0
            try:
                cache_size_bytes = sum(len(pickle.dumps(value)) for value in self._cache.values())
            except:
                pass
...
class OptimizationEngine:
    ...
    def start_continuous_monitoring(self) -> None:
        ...
        self._optimization_thread = threading.Thread(target=self._monitoring_loop, daemon=True)
    ...
    def get_optimization_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "last_optimization": (
                self.optimization_history[-1].optimization_type
