...
from .profiler import ProfilerManager, SystemMetrics, global_profiler
...
class PerformanceMonitor:
    ...
    def _render_performance_overview(self) -> None:
        ...
        with col1:
            cpu_color = self._get_status_color(
        ...
        with col2:
            memory_color = self._get_status_color(
        ...
        with col3:
            cache_color = self._get_status_color(
    ...
    def _render_system_metrics(self) -> None:
        ...
        # Update layout
        fig.update_layout(
            height=600, showlegend=True, title_text="System Performance Metrics Over Time"
        )
    ...
    def _render_cache_performance(self) -> None:
        ...
        with col1:
            ...
            fig_pie.update_layout(
                ...
                annotations=[
                    dict(
                        text=f"{cache_metrics.hit_rate:.1%}",
                        x=0.5,
                        y=0.5,
                        font_size=20,
                        showarrow=False,
