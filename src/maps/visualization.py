    ...
    def create_3d_surface(
        ...
        try:
            ...
            surface = go.Surface(
                ...
                ) if config.show_colorbar else None
            )
        ...
        fig.update_layout(
            ...
            scene=dict(
                xaxis=dict(
                    ...
                    ticktext=[x_labels[i] for i in range(0, len(x_labels), max(1, len(x_labels)//8))],
                    titlefont=dict(color=self._theme_colors['text']),
                    tickfont=dict(color=self._theme_colors['text']),
