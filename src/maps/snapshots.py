...
class MapSnapshots:
    ...
    def compare_snapshots(
        ...
        try:
            ...
            logger.debug(f"Compared snapshots {snapshot_id_1} vs {snapshot_id_2}: "
    ...
    def delete_snapshot(self, snapshot_id: str) -> None:
        ...
        try:
            with self._get_db_connection() as conn:
                ...
                if cursor.fetchone()[0] > 0:
                    raise ValueError(f"Cannot delete snapshot {snapshot_id}: other snapshots depend on it")
        ...
        try:
            with self._get_db_connection() as conn:
                ...
                return {
                    ...
                    'compression_ratio': (db_file_size / max(total_size, 1)) if total_size > 0 else 0,
