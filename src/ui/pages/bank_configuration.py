    ...
    with st.expander("Informações do Veículo", expanded=True):
        ...
        with st.form("vehicle_info_form"):
            ...
            with col1:
                ...
                year = st.number_input("Ano", min_value=1900, max_value=2030, value=int(vehicle.get('year', 2020)), key="year_input")
            ...
            with col3:
                ...
                engine_aspiration = st.selectbox(
                    ...
                    index=aspiration_options.index(current_aspiration) if current_aspiration in aspiration_options else 0,
        ...
        with st.form("power_analysis_form"):
            ...
            with col1:
                ...
                if is_forced_induction:
                    current_boost = vehicle.get('boost_pressure') or vehicle.get('max_boost_pressure') or 1.0
            ...
            submitted_power = st.form_submit_button("Salvar Configurações de Análise", type="secondary")
            
            if submitted_power:
                update_data = {
                    'bsfc_factor': bsfc_factor
                }
