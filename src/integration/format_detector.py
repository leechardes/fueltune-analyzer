...
class FTManagerFormatDetector:
    ...
    def detect_format(
        ...
        try:
            ...
            return DetectionResult(
                ...
                errors=[] if success else [f"Confidence {best_candidate.confidence:.2f} below threshold {confidence_threshold}"],
                warnings=preprocessing_warnings,
                detection_metadata={
                    'detection_time': detection_start.isoformat(),
                    ...
                    'candidate_analysis': {
                        ...
                        'confidence_range': [candidates[-1].confidence, candidates[0].confidence] if candidates else [0, 0]
                    },
        ...
        try:
            ...
            return {
                ...
                'character_analysis': {
                    ...
                    'most_common': sorted(char_frequencies.items(), key=lambda x: x[1], reverse=True)[:10]
                },
        ...
        for sep_char, sep_info in self.separator_patterns.items():
            ...
            for line in lines[:10]:  # Analyze first 10 lines
                ...
                if count > 0:
                    ...
                    numeric_fields = sum(1 for field in fields if self._is_numeric_field(field.strip()))
    ...
    def _determine_format_type(self, content: str, separator: str) -> Literal['tabulated', 'csv', 'hex', 'binary']:
